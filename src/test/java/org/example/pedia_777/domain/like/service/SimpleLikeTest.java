...
public class SimpleLikeTest {
    ...
    public void testConcurrentLikesWithDistributedLock() throws InterruptedException {
        ...
        assertNotEquals(memberCount, successCount.get());
        assertNotEquals(0, failCount.get());
        assertNotEquals(memberCount, likeCount);
        assertNotEquals(memberCount, finalReview.getLikeCount());
    }
